...
/* src/components/Header.svelte generated by Svelte v4.2.19 */
...
function create_fragment$7(ctx) {
	...
	const block = {
		c: function create() {
			...
			div3 = element("div");
			div2 = element("div");
			t1 = text("Canal Marina\r\n         ");
			div1 = element("div");
			div1.textContent = "Seattle, WA";
			t3 = space();
			nav = element("nav");
			a0 = element("a");
			a0.textContent = "Location";
			t5 = space();
			a1 = element("a");
			a1.textContent = "Amenities";
			t7 = space();
			a2 = element("a");
			a2.textContent = "Green Initiative";
			t9 = space();
			a3 = element("a");
			a3.textContent = "Contact";
			attr_dev(img, "class", "cm-logo");
			if (!src_url_equal(img.src, img_src_value = "CM_logo.png")) attr_dev(img, "src", img_src_value);
			attr_dev(img, "alt", "Canal Marina Logo");
			add_location(img, file$7, 8, 8, 163);
			attr_dev(div0, "class", "column-left svelte-1cbolqd");
			add_location(div0, file$7, 7, 6, 126);
			attr_dev(div1, "class", "address svelte-1cbolqd");
			add_location(div1, file$7, 12, 9, 326);
			attr_dev(div2, "class", "title svelte-1cbolqd");
			add_location(div2, file$7, 11, 8, 284);
			attr_dev(div3, "class", "column-right svelte-1cbolqd");
			add_location(div3, file$7, 10, 6, 248);
			attr_dev(div4, "class", "row svelte-1cbolqd");
			add_location(div4, file$7, 6, 4, 101);
			add_location(div5, file$7, 5, 2, 90);
			attr_dev(a0, "href", "/location");
			add_location(a0, file$7, 19, 4, 435);
			attr_dev(a1, "href", "/amenities");
			add_location(a1, file$7, 20, 4, 482);
			attr_dev(a2, "href", "/green-init");
			add_location(a2, file$7, 21, 4, 531);
			attr_dev(a3, "href", "/contact");
			add_location(a3, file$7, 22, 4, 588);
			attr_dev(nav, "class", "svelte-1cbolqd");
			add_location(nav, file$7, 18, 2, 424);
			attr_dev(header, "class", "svelte-1cbolqd");
			add_location(header, file$7, 4, 0, 78);
		},
		l: function claim(nodes) {
...
/* src/components/ServiceWorker.svelte generated by Svelte v4.2.19 */

const { console: console_1 } = globals;
const file$6 = "src/components/ServiceWorker.svelte";
...
function create_if_block(ctx) {
	...
	const block = {
		c: function create() {
			...
			add_location(div, file$6, 65, 2, 2180);
		},
		m: function mount(target, anchor) {
...
function create_if_block_1(ctx) {
	...
	const block = {
		c: function create() {
			...
			add_location(linearGradient1, file$6, 93, 12, 3150);
			attr_dev(defs, "id", "defs2");
			add_location(defs, file$6, 80, 10, 2710);
			...
			add_location(path, file$6, 104, 12, 3499);
			...
			add_location(animateTransform, file$6, 109, 12, 3980);
			attr_dev(g, "id", "spinner-arc");
			add_location(g, file$6, 102, 10, 3452);
			...
			add_location(svg, file$6, 72, 8, 2456);
			attr_dev(div, "id", "spinner");
			attr_dev(div, "class", "svelte-bgh5jt");
			add_location(div, file$6, 71, 6, 2355);
		},
		m: function mount(target, anchor) {
...
/* src/routes/Location.svelte generated by Svelte v4.2.19 */
const file$5 = "src/routes/Location.svelte";
...
function create_fragment$5(ctx) {
	...
	const block = {
		c: function create() {
			...
			address.textContent = "CANAL MARINA, LLC.\r\n    360 West Ewing Street\r\n    Seattle, WA 98119";
			t3 = space();
			p = element("p");
			p.textContent = "Canal Marina is located on the Lake Washington Ship Canal. It is immediately\r\n    across from the Burke-Gilman Trail and only steps from Seattle Pacific\r\n    University. The marina can be found between the Freemont and Ballard bridge\r\n    and a close hop to the Freemont restaurant and entertainment district and\r\n    close to the Ballard shopping area as well as lower Queen Anne Hill and\r\n    Magnolia. It is only minutes to downtown Seattle, University of Washington\r\n    and Gas Works Park. The Space Needle is only a thirteen-minute drive from\r\n    the marina.";
			t5 = space();
			div = element("div");
			iframe = element("iframe");
			add_location(h1, file$5, 0, 0, 0);
			add_location(address, file$5, 1, 0, 19);
			add_location(p, file$5, 5, 0, 110);
			if (!src_url_equal(iframe.src, iframe_src_value = "https://www.google.com/maps/embed?pb=!1m18!1m12!1m3!1d2689.510235748563!2d-122.36264068436992!3d47.65423997918962!2m3!1f0!2f0!3f0!3m2!1i1024!2i768!4f13.1!3m3!1m2!1s0x549015d6f2b5e9d7%3A0x8c8b8b8b8b8b8b8b!2s360%20W%20Ewing%20St%2C%20Seattle%2C%20WA%2098119%2C%20USA!5e0!3m2!1sen!2sus!4v1616176176176!5m2!1sen!2sus")) attr_dev(iframe, "src", iframe_src_value);
			attr_dev(iframe, "width", "600");
			attr_dev(iframe, "height", "450");
			set_style(iframe, "border", "0");
			iframe.allowFullscreen = "";
			attr_dev(iframe, "loading", "eager");
			attr_dev(iframe, "title", "Google Map");
			add_location(iframe, file$5, 18, 4, 769);
			attr_dev(div, "class", "map-container");
			add_location(div, file$5, 17, 0, 736);
		},
		l: function claim(nodes) {
			throw new Error("options.hydrate only works if the component was compiled with the `hydratable: true` option");
		},
...
/* src/routes/Amenities.svelte generated by Svelte v4.2.19 */
const file$4 = "src/routes/Amenities.svelte";
...
function create_fragment$4(ctx) {
	...
	const block = {
		c: function create() {
			...
			t1 = space();
			li0 = element("li");
			li0.textContent = "Covered and Uncovered Moorage Slips";
			t3 = space();
			li1 = element("li");
			li1.textContent = "Property Manager on Site & Canal Marina Office";
			t5 = space();
			li2 = element("li");
			li2.textContent = "Wi-Fi Service";
			t7 = space();
			li3 = element("li");
			li3.textContent = "Shower & Bathroom Facilities";
			t9 = space();
			li4 = element("li");
			li4.textContent = "Laundry Facility";
			t11 = space();
			li5 = element("li");
			li5.textContent = "Kayak & Canoe Storage";
			t13 = space();
			li6 = element("li");
			li6.textContent = "Secure Bicycle Storage";
			t15 = space();
			li7 = element("li");
			li7.textContent = "Motorcycle & Moped Tie-Ups";
			t17 = space();
			li8 = element("li");
			li8.textContent = "Free Parking Limited Houseboat Moorage";
			t19 = space();
			li9 = element("li");
			li9.textContent = "Security Fence to Al Docks with Keyed Entry Gates";
			t21 = space();
			li10 = element("li");
			li10.textContent = "Garbage & Recycling Service";
			t23 = space();
			li11 = element("li");
			li11.textContent = "Electrical Hookups to Boats";
			t25 = space();
			li12 = element("li");
			li12.textContent = "Individual Water Spigots to Each Marina Slip";
			t27 = space();
			li13 = element("li");
			li13.textContent = "Secure Nighttime Lighting";
			t29 = space();
			li14 = element("li");
			li14.textContent = "Mailboxes o n Site";
			t31 = space();
			li15 = element("li");
			li15.textContent = "Limited Tenant Vegetable Gardens";
			t33 = space();
			li16 = element("li");
			li16.textContent = "Tenant BBQ Facility";
			t35 = space();
			li17 = element("li");
			li17.textContent = "Gazebo with Lawn for Year Around Tenant Functions";
			t37 = space();
			li18 = element("li");
			li18.textContent = "Tenant Storage Facilities";
			t39 = space();
			li19 = element("li");
			li19.textContent = "Dog Release Station with Bags";
			t41 = space();
			li20 = element("li");
			li20.textContent = "Email Service to Keep Tenants Up to Date on Latest Dev";
			add_location(h1, file$4, 1, 0, 1);
			add_location(li0, file$4, 2, 0, 20);
			add_location(li1, file$4, 3, 0, 66);
			add_location(li2, file$4, 4, 0, 122);
			add_location(li3, file$4, 5, 0, 145);
			add_location(li4, file$4, 6, 0, 183);
			add_location(li5, file$4, 7, 0, 209);
			add_location(li6, file$4, 8, 0, 240);
			add_location(li7, file$4, 9, 0, 272);
			add_location(li8, file$4, 10, 0, 308);
			add_location(li9, file$4, 11, 0, 356);
			add_location(li10, file$4, 12, 0, 415);
			add_location(li11, file$4, 13, 0, 452);
			add_location(li12, file$4, 14, 0, 489);
			add_location(li13, file$4, 15, 0, 543);
			add_location(li14, file$4, 16, 0, 578);
			add_location(li15, file$4, 17, 0, 606);
			add_location(li16, file$4, 18, 0, 648);
			add_location(li17, file$4, 19, 0, 677);
			add_location(li18, file$4, 20, 0, 736);
			add_location(li19, file$4, 21, 0, 771);
			add_location(li20, file$4, 22, 0, 810);
		},
		l: function claim(nodes) {
			throw new Error("options.hydrate only works if the component was compiled with the `hydratable: true` option");
		},
		m: function mount(target, anchor) {
			...
			insert_dev(target, li12, anchor);
			insert_dev(target, t27, anchor);
			insert_dev(target, li13, anchor);
			insert_dev(target, t29, anchor);
			insert_dev(target, li14, anchor);
			insert_dev(target, t31, anchor);
			insert_dev(target, li15, anchor);
			insert_dev(target, t33, anchor);
			insert_dev(target, li16, anchor);
			insert_dev(target, t35, anchor);
			insert_dev(target, li17, anchor);
			insert_dev(target, t37, anchor);
			insert_dev(target, li18, anchor);
			insert_dev(target, t39, anchor);
			insert_dev(target, li19, anchor);
			insert_dev(target, t41, anchor);
			insert_dev(target, li20, anchor);
		},
		p: noop,
		i: noop,
		o: noop,
...
function instance$4($$self, $$props) {
	let { $$slots: slots = {}, $$scope } = $$props;
	validate_slots('Amenities', slots, []);
	const writable_props = [];

	Object.keys($$props).forEach(key => {
		if (!~writable_props.indexOf(key) && key.slice(0, 2) !== '$$' && key !== 'slot') console.warn(`<Amenities> was created with unknown prop '${key}'`);
	});

	return [];
}

class Amenities extends SvelteComponentDev {
	constructor(options) {
		super(options);
...
/* src/routes/GreenInit.svelte generated by Svelte v4.2.19 */
const file$3 = "src/routes/GreenInit.svelte";
...
function create_fragment$3(ctx) {
	...
	const block = {
		c: function create() {
			h1 = element("h1");
			h1.textContent = "Green Initiative";
			t1 = space();
			p = element("p");
			p.textContent = "Canal Marina is committed to keeping our water and environment clean while\n    providing facilities for recreational boaters and live aboard tenants. Protecting\n    our waters, marine life, fish and waterfowl from boat and marina pollutants is\n    a major goal for us. Our staff along with every boater work together to keep the\n    marina and environment clean.";
			add_location(h1, file$3, 0, 0, 0);
			add_location(p, file$3, 1, 0, 26);
		},
		l: function claim(nodes) {
			throw new Error("options.hydrate only works if the component was compiled with the `hydratable: true` option");
		},
...
function instance$3($$self, $$props) {
	let { $$slots: slots = {}, $$scope } = $$props;
	validate_slots('GreenInit', slots, []);
	const writable_props = [];

	Object.keys($$props).forEach(key => {
		if (!~writable_props.indexOf(key) && key.slice(0, 2) !== '$$' && key !== 'slot') console.warn(`<GreenInit> was created with unknown prop '${key}'`);
	});

	return [];
}

class GreenInit extends SvelteComponentDev {
	constructor(options) {
		super(options);
...
/* src/routes/NotFound.svelte generated by Svelte v4.2.19 */
...
/* src/routes/Contact.svelte generated by Svelte v4.2.19 */
...
function create_fragment$1(ctx) {
	...
	const block = {
		c: function create() {
			...
			t1 = space();
			p0 = element("p");
			p0.textContent = "Telephone: (509) 999-4220";
			t3 = space();
			p1 = element("p");
			t4 = text("Email: ");
			a = element("a");
			a.textContent = "canalmarinallc@gmail.com";
			add_location(h1, file$1, 0, 0, 0);
			add_location(p0, file$1, 1, 0, 25);
			attr_dev(a, "href", "mailto:canalmarinallc@gmail.com");
			add_location(a, file$1, 2, 10, 68);
			add_location(p1, file$1, 2, 0, 58);
		},
		l: function claim(nodes) {
			throw new Error("options.hydrate only works if the component was compiled with the `hydratable: true` option");
		},
