...
const cacheName = `0.1.0:89976ede`; // Change value to force update
const essentialFilesToCache = `["./","build/main.js.map","build/main.js","build/bundle.css"]`; // Generated filenames as string array
